        ...
        <div className="space-y-6">
            ...
            <div className="bg-card border border-border rounded-xl p-5 shadow-sm">
                <div className="flex items-center gap-2 mb-5">
                    ...
                    <h3 className="text-xs font-semibold text-muted-foreground uppercase tracking-wider">
                        {t("trips.odometerMap.odometerTitle")}
                    </h3>
                </div>
                ...
                <div className="space-y-4">
                    <div className="flex justify-between items-center pb-3 border-b border-border/50">
                        <span className="text-sm text-muted-foreground font-medium">
                            {t("trips.odometerMap.startReading")}
                        </span>
                        <span className="text-base font-semibold">
                            {trip.start_km ? `${trip.start_km.toLocaleString()} km` : "—"}
                        </span>
                    </div>
                    <div className="flex justify-between items-center pb-3 border-b border-border/50">
                        <span className="text-sm text-muted-foreground font-medium">
                            {t("trips.odometerMap.endReading")}
                        </span>
                        <span className="text-base font-semibold">
                            {trip.end_km ? `${trip.end_km.toLocaleString()} km` : "—"}
                        </span>
                    </div>

                    <div className="pt-2 bg-secondary/30 -mx-5 -mb-5 p-5 rounded-b-xl border-t border-border/50 mt-4">
                        <span className="text-xs font-semibold text-muted-foreground uppercase tracking-wider block mb-1">
                            {t("trips.odometerMap.totalDistance")}
                        </span>
            ...
            <div className="bg-card border border-border rounded-xl p-5 shadow-sm">
                <div className="flex items-center gap-2 mb-5">
                    ...
                    <h3 className="text-xs font-semibold text-muted-foreground uppercase tracking-wider">
                        {t("trips.odometerMap.routeTitle")}
                    </h3>
                </div>
                ...
                <div className="space-y-3">
                    ...
                    {(startCoords || endCoords) ? (
                        <div className="w-full h-48 sm:h-56 rounded-lg overflow-hidden border border-border relative mt-4 bg-secondary/20">
                            ...
                            <iframe
                                title={t("trips.odometerMap.routeTitle")}
                                width="100%"
                                height="100%"
                                style={{ border: 0 }}
                                loading="lazy"
                        ...
                        <div className="w-full h-32 mt-4 rounded-lg border border-dashed border-border/60 bg-secondary/20 flex flex-col items-center justify-center text-muted-foreground p-4 text-center">
                            ...
                            <p className="text-xs">{t("trips.odometerMap.noLocation")}</p>
                        </div>
                    )}
                </div>
            </div>
